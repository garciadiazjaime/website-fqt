...
urlpatterns = patterns('',    
    ...
    url(r'^inversionistas_sociales$', 'app.front.views.inversiones_sociales', name='inversiones_sociales'),
        url(r'^inversiones_sociales/(?P<category>[^/]+)$', 'app.front.views.inversiones_sociales', name='inversiones_sociales'),
